    ...
    return (
        <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
            ...
            <div>
                ...
                <span className="text-lg ml-1 font-normal text-gray-400">/</span>
                <span className="text-lg ml-1 font-normal text-gray-400">{duration_abonement}</span>
                </h1>
            </div>
            {descript_abonement && Array.isArray(descript_abonement) && descript_abonement.map((oneDescript, index) => (
